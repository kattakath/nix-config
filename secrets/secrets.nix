...
let
  ...
  # nixpi host key (/etc/ssh/ssh_host_ed25519_key.pub) — regenerated by the 2026-07-15 SD reflash.
  nixpi = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIKMaA1K6f1fDH+ZCw2m0/wv6Tdd3q9XwlWYA5DMtR0Ig";
