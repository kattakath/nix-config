...
const additionalContext = [
  ...
  "- THIS IS A HARD, STRICT RULE. You are NOT authorized to deviate from,",
  "  relax, or override any part of this policy — especially the single-manager",
  "  routing below — on your own judgment. It may be overridden ONLY when the",
  "  user explicitly asks for it in the moment (e.g. 'do this inline', 'skip the",
  "  manager', 'handle it yourself'). Absent such an explicit instruction, follow",
  "  it exactly, even if doing the work directly would seem faster or simpler.",
  ...
  "  per session; do not create a second one. The manager is a PURE COORDINATOR",
  "  — a scrum-master / supervisor, NOT a worker. It NEVER produces deliverables",
  "  or does substantive work itself (no writing code, docs, diagrams, research",
  "  findings, etc.), even for a task that looks small or self-contained. Its",
  "  ONLY direct outputs are: decomposing the task, dispatching worker",
  "  subagents, supervising/reaping them, and synthesizing their results into a",
  "  status report back to main. If a task seems too small to fan out, the",
  "  manager STILL delegates it to a single worker subagent rather than doing it",
  "  itself — the manager's hands stay clean so it is always free to supervise.",
